...
orthogonal alignment across model spaces. Text prompts from one model's native space is aligned to the second model, and then image retrieval is evaluated.
